<?php
    ...
    $queryRealizadas="select c.Codigo,c.Asunto,a.NCuenta,c.Fecha, concat(a.PNombre,' ',a.SNombre,' ',a.PApellido,' ',a.SApellido) as Estudiante, concat(m.Nombre,' ',m.Apellido) as Medico, 
    c.Hora_I as Hora from Cita as c inner join alumno as a on c.AlumnoID = a.AlumnoID
    inner join medico as m on c.MedicoID = m.MedicoID 
    inner join area as ar on c.AreaID = ar.AreaID where c.AreaID = '$areaID' and EstadoID = 2 and month(c.Fecha) = month(now()) and m.medicoID = '$medicoID' order by Fecha";
    ...
    <?php include 'template/nav.php'; ?>
        ...
        <?php include 'template/icon-logo.php';?>            
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <h2 class="pb-3">Citas Realizadas en <?php echo $NArea?> - <?php echo $mes.' '.$anio?></h2>
